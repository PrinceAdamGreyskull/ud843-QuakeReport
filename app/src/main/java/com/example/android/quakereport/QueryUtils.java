...
public final class QueryUtils {
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject tmpEarthquake;
            JSONObject tmpProperties;
            double magnitude;
            String location;
            long date;
            for(int i = 0; i < featuresArray.length(); i++) {
                // Get earthquake JSONObject at position i
                tmpEarthquake = featuresArray.getJSONObject(i);
                // Get “properties” JSONObject
                tmpProperties = tmpEarthquake.getJSONObject("properties");

                // Extract magnitude, location and time from the quake properties
                magnitude = tmpProperties.getDouble("mag");
